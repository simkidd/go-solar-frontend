    ...
    <div className="w-full min-h-dvh flex flex-col items-center justify-center bg-linear-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950  transition-colors duration-300">
      <div className="flex flex-col items-center">
        ...
        <div className="relative flex items-center justify-center w-28 h-28 rounded-full bg-white dark:bg-zinc-900 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-zinc-200/50 dark:border-zinc-800/50">
          ...
          <div className="absolute -inset-1 rounded-full border border-primary/10 dark:border-primary/5"></div>

          {/* Main spinning orbit ring */}
          <div className="absolute -inset-2.5 rounded-full border-2 border-transparent border-t-primary border-r-primary/30 animate-spin [animation-duration:1.5s]"></div>

          {/* Secondary slower counter-spinning ring */}
          <div className="absolute -inset-4 rounded-full border border-transparent border-b-primary/40 border-l-primary/10 animate-spin [animation-direction:reverse] [animation-duration:2.5s]"></div>

          {/* Glowing pulse ring in the background */}
          <div className="absolute inset-2 rounded-full bg-primary/5 animate-ping [animation-duration:2s]"></div>
        ...
        <div className="mt-8 flex flex-col items-center space-y-1.5 text-center">
          <span className="font-dmsans text-lg font-bold tracking-widest text-primary">
            GoSolar Ng
          </span>
          <div className="flex items-center space-x-1.5">
            ...
            <span className="flex space-x-1 items-center justify-center h-2">
              ...
              <span className="w-1 h-1 bg-primary rounded-full animate-bounce [animation-delay:300ms]"></span>
            </span>
          </div>
        </div>
      </div>
