...
const AdminSidebar = () => {
  ...
  return (
    <div className="-left-full flex md:left-0 flex-col h-screen fixed top-0 z-50 lg:w-[220px] md:w-[80px] w-[220px] transition-all duration-500 ease-linear shadow-md bg-white dark:bg-[#222327]">
