...
const CategoryTable = () => {
  ...
  const [activeTab, setActiveTab] = useState<"topLevel" | "subcategories">("topLevel");
                            ...
                            <DropdownMenu>
                              ...
                              >
                                ...
                                <DropdownMenuItem
                                  ...
                                  className="cursor-pointer text-red-655 focus:text-red-655 focus:bg-red-500/10 text-xs font-bold"
                                >
