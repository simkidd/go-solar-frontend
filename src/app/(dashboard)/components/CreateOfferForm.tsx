...
const CreateOfferForm: React.FC<{
  ...
  const { loading, createOffer, updateOffer } = useProductStore();
  ...
  useEffect(() => {
    if (existingOffer) {
      setInput({
        ...
        percentageOff: existingOffer?.percentageOff,
        priceSlash: existingOffer?.priceSlash,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (existingOffer) {
      await updateOffer({ ...input, id: existingOffer._id });
    } else {
