                ...
                {matchedPackage ? (
                  <div className="border border-emerald-100 dark:border-emerald-900/40 bg-linear-to-br from-emerald-50 to-white dark:from-emerald-950/20 dark:to-zinc-900 rounded-2xl p-6 shadow-sm space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 dark:text-zinc-455 mt-1 leading-relaxed">
                        {matchedPackage.desc}
                      </p>
                    </div>
                  ...
                  <div className="border border-amber-200 dark:border-amber-900/40 bg-amber-50 dark:bg-amber-950/15 rounded-2xl p-6 space-y-3">
                    <div className="flex gap-3">
                      <CloudLightning className="h-5 w-5 text-amber-600 flex-shrink-0" />
                      <div>
                        <p className="text-sm font-bold text-amber-800 dark:text-amber-300">
                          Custom Solar System Sizing Required
                        </p>
                        <p className="text-xs text-amber-700/80 dark:text-amber-400/80 mt-1 leading-relaxed">
                          Your load sizing requirements exceed our packaged
                          specifications. Fill out your details below, and our
                          Port Harcourt engineering team will contact you to
