...
export const PACKAGES_DATA: PackageData[] = [
  ...
  {
    id: "pkg-100-industrial",
    name: "10KVA SOLAR PACKAGE",
    inverterRange: "10 kVA",
    desc: "10kva solar package solution for heavy residential and commercial load coverage including multiple air conditioners and workspace machinery.",
    spec: "10kVA Inverter + 30.0kWh Lithium Battery + 30x 560W Black Solar Panels",
    price: 14500000,
    slug: "10kva-solar-package-6653",
    ...
    constituents: [
      ...
      {
        id: "comp-bat-150-lit",
        name: "15.0kWh Lithium Battery Bank",
        qty: 2,
        price: 3800000,
        slug: "15kwh-lithium-battery",
        categoryName: "Batteries",
        categorySlug: "batteries",
        imageUrl: "/images/products/battery.png",
      },
      {
        id: "comp-pan-560w",
        name: "560W Black Mono Solar Panel",
        qty: 30,
        price: 170000,
        slug: "560w-mono-panel",
        categoryName: "Solar Panels",
        categorySlug: "solar-panels",
        imageUrl: "/images/products/panels.png",
      },
